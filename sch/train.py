...
def run():
    ...
    train = atoms(config.data_dir+'schtrain.db', available_properties=['sol'])
    val = atoms(config.data_dir+'schval.db', available_properties=['sol'])
    test = atoms(config.data_dir+'schtest.db', available_properties=['sol'])
